      ...
      <div className="detail">
        <div className='top'>
          ...
          <Breadcrumb>
            ...
            <Breadcrumb.Item>
              <Link to="/admin/active" className="link">教务动态</Link>
            </Breadcrumb.Item>
            <Breadcrumb.Item>
              <Link to="/admin/active/detail" className="link">教务动态详情</Link>
            </Breadcrumb.Item>
          </Breadcrumb>
        </div>
...
export default AdminActiveDetail;